...
export const metadata: Metadata = {
  ...
  description:
    "Roman Kushnarov is an IT business analyst who builds impressive, impactful products and digital experiences for the web.",
  icons: {
    icon: [
  ...
  openGraph: {
    title: "Roman Kushnarov",
    description:
      "Roman Kushnarov is an IT business analyst creating impressive and impactful digital experiences.",
